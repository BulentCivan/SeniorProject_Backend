    ...
    public partial class update1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    AppUserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    ParadigmId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserParadigms", x => new { x.AppUserId, x.ParadigmId });
                    table.ForeignKey(
                        name: "FK_UserParadigms_AspNetUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserParadigms_Paradigms_ParadigmId",
                        column: x => x.ParadigmId,
                        principalTable: "Paradigms",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
